                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Notes</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="masuk.php">Memasukan Barang</a></li>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										...
										<tr>
										 ...
										 <td>Cara menggunakan aplikasi ini adalah dengan pergi ke halaman "Barang masuk" atau Klik link diatas yang bertuliskan "Memasukan Barang" maka anda akan langsung dialihkan ke halaman input barang. Seketika tiba di halaman memasukan barang, anda bisa langsung memasukan data barang dengan meng-klik tombol "Tambah barang", setelah itu anda bisa menentukan jumlah barang tersebut lalu klik simpan.
                                            Jika anda ingin mengeluarkan barang maka anda bisa klik di menu sidebar yang bertuliskan "Transaksi Data" lalu klik "Barang keluar", dan setibanya disana anda bisa meng-klik tombol "Keluarkan Barang" lalu pilih barang yang akan dikeluarkan dan klik "simpan". Untuk melihat konten barang yang tersimpan di aplikasi ini anda dapat meng-klik tombol Stock barang di menu sidebar. Anda juga bisa meng-ekspor data yang tersimpan di table aplikasi ini dengan mencari dan meng-klik tombol "Ekspor Data" yang terletak di setiap halaman barang masuk,keluar dan stock barang, fitur ini bisa mengkonversi data menjadi PDF, EXCEL dan Print.
