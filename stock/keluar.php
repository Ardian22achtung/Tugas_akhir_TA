                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Keluar</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Barang Keluar</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Keluarkan Barang</button>
                                </div>
										 ...
										 <table id="dataTable3" class="table table-hover"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($brg)){
												...
												<tr>
                                                    ...
                                                    <td><button data-toggle="modal" data-target="#edit<?=$id;?>" class="btn btn-warning"><i class="fas fa-wand-magic-sparkles"></i></button> <button data-toggle="modal" data-target="#del<?=$id;?>" class="btn btn-danger"><i class="fas fa-trash"></i></button></td>
												</tr>		
