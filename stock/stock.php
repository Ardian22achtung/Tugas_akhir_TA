												...
												<tr>
													...
													<td><?php echo $p['lokasi'] ?></td>
                                                        <?php 
                                                            if(!empty($p['foto'])){
                                                                ?> 
                                                                    <td><img src="../img/<?php echo $p['foto'] ?>" style="max-height: 100px;"></td>
                                                                <?php
                                                            }else{
                                                                ?>  
                                                        ...
                                                        ?>
                                                    <td><button data-toggle="modal" data-target="#edit<?=$idb;?>" class="btn btn-warning"><i class="fas fa-wand-magic-sparkles"></i></button> <button data-toggle="modal" data-target="#del<?=$idb;?>" class="btn btn-danger"><i class="fas fa-trash"></i></button></td>
												</tr>
